...
use OCA\Virwork_API\Db\VirworkGroupAuth;
use OCA\Virwork_API\Db\VirworkGroupAuthMapper;
use OCA\Virwork_API\Db\VirworkGroupRlsAuth;
use OCA\Virwork_API\Db\VirworkGroupRlsAuthMapper;
...
class VirworkGroupsController extends Controller {
	...
	/** @var VirworkGroupAuthMapper */
	protected $virworkGroupAuthMapper;
	/** @var VirworkGroupRlsAuthMapper */
	protected $virworkGroupRlsAuthMapper;
	 ...
	 * @param VirworkGroupAuthMapper $virworkGroupAuthMapper
	 * @param VirworkGroupRlsAuthMapper $virworkGroupRlsAuthMapper
	 */
	public function __construct($appName, 
	    ...
	    VirworkGroupAuthMapper $virworkGroupAuthMapper,
	    VirworkGroupRlsAuthMapper $virworkGroupRlsAuthMapper){
		...
		$this->virworkGroupAuthMapper = $virworkGroupAuthMapper;
		$this->virworkGroupRlsAuthMapper = $virworkGroupRlsAuthMapper;
	}
    /**
      * @NoAdminRequired
      */
    ...
    /**
	 * ip/nextcloud/index.php/apps/virwork_api/virwork_groups
    ...
    public function api(): DataResponse {
     ...
     /**
	 * ip/nextcloud/index.php/apps/virwork_api/virwork_groups/all
	 * returns a list of users
	 *
	 * @PublicPage 
	 * @NoAdminRequired
    ...
    public function getGroups(): DataResponse {
		...
		$groups = $this->virworkGroupAuthMapper->findAll();


		$group_rls = $this->virworkGroupRlsAuthMapper->findAll();

		$groups = array_map(function($group) {
			/** @var VirworkGroupAuth $group */
			return $group;
		}, $groups);
