...
class VirworkRolesController extends Controller {
    ...
    /**
	 * ip/nextcloud/index.php/apps/virwork_api/virwork_roles/all
	 * returns a list of users
	 *
	 * @PublicPage 
	 * @NoAdminRequired
    ...
    public function getRoles(): DataResponse {
		$roles = $this->virworkRoleAuthMapper->findAll();


		$roles = array_map(function($role) {
			/** @var VirworkRoleAuth $role */
			return $role;
		}, $roles);
